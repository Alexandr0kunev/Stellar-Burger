...
describe('Тесты редьюсера ingredients', () => {
  ...
  test('Должен обрабатывать экшен getIngredients.rejected с сообщением об ошибке', () => {
    const action = {
  ...
  test('Должен обрабатывать экшен getIngredients.rejected без сообщения об ошибке', () => {
    const action = {
      type: getIngredients.rejected.type,
      error: {}
    };
